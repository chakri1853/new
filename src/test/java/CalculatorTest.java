...
public class CalculatorTest {
    ...
    public void factorialFalsePositive(){
        assertNotEquals("Finding factorial of a number for False Positive", 6, calculator.fact(6), DELTA);
    ...
    public void powerFalsePositive(){
        assertNotEquals("Finding power for False Positive", 64, calculator.power(3, 4), DELTA);
        assertNotEquals("Finding power for False Positive", -7.3, calculator.power(5, 21), DELTA);
    }
    ...
    public void sqrootTruePositive(){
        ...
        assertEquals("Finding square root for True Positive", 7, calculator.sqroot(49), DELTA);
    }

    @Test
    public void sqrootFalsePositive(){
        assertNotEquals("Finding square root for False Positive", 1, calculator.sqroot(4), DELTA);
        assertNotEquals("Finding square root for False Positive", 0, calculator.sqroot(25), DELTA);
